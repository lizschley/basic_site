       ...
       <ul class='navbar-liz list-unstyled me-auto mb-2 mb-sm-0'>
          ...
          <li class='nav-item dropdown'>
             ...
             <ul class='dropdown-menu'>
                <li class='list-item'><a class='dropdown-item' href='plant_overview.html'>Overview of Plant Project</a></li>
                <li class='list-item'><a class='dropdown-item ' href='community.html'>Home Plant Communities</a></li>
                <li class='list-item'><a class='dropdown-item' href='va_native.html'>Virginia Natives</a></li>
                <li class='list-item'><a class='dropdown-item ' href='native_east_us.html'>East US Natives</a></li>
                <li class='list-item'><a class='dropdown-item' href='non_native.html'>Non Natives</a></li>
             </ul>
          </li>
          <li class='nav-item dropdown'>
             <a id='nav_dropdown' class='dropdown-toggle liz-colors' href='#' data-bs-toggle='dropdown' aria-expanded='false'>Misc Info</a>
             <ul class='dropdown-menu'>
                <li class='list-item'><a class='dropdown-item ' href='tech_q_a.html'>Technical from 2020</a></li>
